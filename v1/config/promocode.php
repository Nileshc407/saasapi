...
$app->add(new \Slim\Middleware\SessionCookie(array(
	...
	$app->post('/promocode','authenticate', function() use ($app) {
            ...
            verifyRequiredParams(array('membershipid','phoneno','promocode'),$request_array);			
            $response = array();
			...
			$Todays_date = $date->format('Y-m-d');	
						...
						if ($user != NULL) {
								...
								// echo "---points---".$param['points']."----<br>";


									$PomocodeDetails = $promoCObj->getPomocodeDetails($param['promocode']);
							
									//  print_r($PomocodeDetails); 
									
									// $num_rows= count($PomocodeDetails);
									// echo "---num_rows---".$num_rows."----<br>";
									/* echo "---Promo_code_status---".$PomocodeDetails['Promo_code_status']."----<br>"; */
									...
									if($PomocodeDetails['Promo_code_status'] == '0'){
										...
										// $updateData['Bill_no']=$tp_bill2;
										// $wherefiled='Promo_code';
										// $wherefiledvalue=$PomocodeDetails['Promo_code'];
